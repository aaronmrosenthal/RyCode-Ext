...
import { unboundDefaultModelId, unboundDefaultModelInfo } from "@rycode-ext/types"
...
const ORIGIN_APP = "rycode-ext"

const DEFAULT_HEADERS = {
	"X-Unbound-Metadata": JSON.stringify({ labels: [{ key: "app", value: "rycode-ext" }] }),
}
