...
export type ExtensionState = Pick<
	...
	// | "showRyCodeExtIgnoredFiles" // Optional in GlobalSettings, required here.
...
> & {
	...
	showRyCodeExtIgnoredFiles: boolean // Whether to show .rycodeextignore'd files in listings
