...
export class DirectoryScanner implements IDirectoryScanner {
	 ...
	 * @param rooIgnoreController Optional RyCodeExtIgnoreController instance for filtering
	...
	public async scanDirectory(
		...
		// Initialize RyCodeExtIgnoreController if not provided
		const ignoreController = new RyCodeExtIgnoreController(directoryPath)

		await ignoreController.initialize()

		// Filter paths using .rycodeextignore
