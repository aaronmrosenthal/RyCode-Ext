...
export class FileWatcher implements IFileWatcher {
	...
	private ignoreController: RyCodeExtIgnoreController
	...
	constructor(
		...
		ignoreController?: RyCodeExtIgnoreController,
		batchSegmentThreshold?: number,
	) {
		this.ignoreController = ignoreController || new RyCodeExtIgnoreController(workspacePath)
		if (ignoreInstance) {
		...
		try {
			...
			if (
				...
				return {
					path: filePath,
					status: "skipped" as const,
					reason: "File is ignored by .rycodeextignore or .gitignore",
				}
			}
