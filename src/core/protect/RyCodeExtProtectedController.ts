 ...
 */
export class RyCodeExtProtectedController {
	private cwd: string
	...
	constructor(cwd: string) {
		...
		this.ignoreInstance.add(RyCodeExtProtectedController.PROTECTED_PATTERNS)
	}
	...
	getInstructions(): string {
		const patterns = RyCodeExtProtectedController.PROTECTED_PATTERNS.join(", ")
	...
	static getProtectedPatterns(): readonly string[] {
		return RyCodeExtProtectedController.PROTECTED_PATTERNS
	}
}
