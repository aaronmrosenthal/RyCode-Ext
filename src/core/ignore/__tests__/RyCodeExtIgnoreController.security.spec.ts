// npx vitest core/ignore/__tests__/RyCodeExtIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { RyCodeExtIgnoreController } from "../RyCodeExtIgnoreController"
...
describe("RyCodeExtIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .rycodeextignore to exist with some patterns
