...
import type { Mode } from "@rycode-ext/modes"
...
vi.mock("@/components/ui/hooks/useRyCodeExtPortal", () => ({
	useRyCodeExtPortal: () => document.body,
}))
...
vi.mock("@rycode-ext/modes", async () => {
	const actual = await vi.importActual<typeof import("@rycode-ext/modes")>("@rycode-ext/modes")
	return {
		...actual,
