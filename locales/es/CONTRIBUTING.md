...
### 3. Únase a la comunidad de RyCode-Ext

- **Principal:** Únase a nuestro [Discord](https://discord.gg/roocode) y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)**.
- **Alternativa:** Los colaboradores experimentados pueden participar directamente a través de [Proyectos de GitHub](https://github.com/orgs/RyCodeExtInc/projects/1).
...
- **Compruebe las incidencias existentes**: busque en [Incidencias de GitHub](https://github.com/RyCodeExtInc/RyCode-Ext/issues).
...
- Consulte el [Proyecto de GitHub](https://github.com/orgs/RyCodeExtInc/projects/1) para ver las incidencias "Incidencia [Sin asignar]".
- Para la documentación, visite [Documentos de RyCode-Ext](https://github.com/RyCodeExtInc/RyCode-Ext-Docs).

### Informar de errores

- Compruebe primero si existen informes.
- Cree un nuevo error utilizando la [plantilla "Informe de error"](https://github.com/RyCodeExtInc/RyCode-Ext/issues/new/choose) con:
    - Pasos de reproducción claros y numerados
    - Resultado esperado vs. real
    - Versión de RyCode-Ext (obligatorio); proveedor/modelo de API si es relevante
- **Problemas de seguridad**: informe de forma privada a través de [avisos de seguridad](https://github.com/RyCodeExtInc/RyCode-Ext/security/advisories/new).
...
```
git clone https://github.com/SU_NOMBRE_DE_USUARIO/RyCode-Ext.git
```
...
Al contribuir, acepta que sus contribuciones se licenciarán bajo la Licencia Apache 2.0, de acuerdo con la licencia de RyCode-Ext.
