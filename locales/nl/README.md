...
<p align="center">
  <em>Snel hulp krijgen → <a href="https://discord.gg/roocode">Word lid van Discord</a> • Liever asynchroon? → <a href="https://www.reddit.com/r/RyCodeExt/">Word lid van r/RyCodeExt</a></em>
</p>
...
## Wat kan RyCode-Ext voor JOU doen?
...
RyCode-Ext past zich aan jouw werkwijze aan, niet andersom:
...
Meer info: [Modi gebruiken](https://docs.roocode.com/basic-usage/using-modes) • [Aangepaste modi](https://docs.roocode.com/advanced-usage/custom-modes) • [Roomote Control](https://docs.roocode.com/rycode-ext-cloud/roomote-control)
...
- **[Documentatie](https://docs.roocode.com):** De officiële gids voor het installeren, configureren en beheersen van RyCode-Ext.
...
- **[Reddit Community](https://www.reddit.com/r/RyCodeExt):** Deel je ervaringen en kijk wat anderen bouwen.
- **[GitHub Issues](https://github.com/RyCodeExtInc/RyCode-Ext/issues):** Meld bugs en volg de ontwikkeling.
- **[Feature Requests](https://github.com/RyCodeExtInc/RyCode-Ext/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Heb je een idee? Deel het met de ontwikkelaars.
...
Er zijn verschillende manieren om de RyCode-Ext-extensie uit te voeren:

### Ontwikkelmodus (F5)

Gebruik voor actieve ontwikkeling de ingebouwde foutopsporing van VSCode:

Druk op `F5` (of ga naar **Uitvoeren** → **Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de RyCode-Ext-extensie wordt uitgevoerd.
...
Dank aan al onze bijdragers die hebben geholpen RyCode-Ext beter te maken!
...
**Veel plezier met RyCode-Ext!** Of je het nu strak aan de lijn houdt of autonoom laat rondlopen, we zijn benieuwd wat je bouwt. Vragen of feature-ideeën? Kom langs op onze [Reddit-community](https://www.reddit.com/r/RyCodeExt/) of [Discord](https://discord.gg/roocode). Happy coding!
