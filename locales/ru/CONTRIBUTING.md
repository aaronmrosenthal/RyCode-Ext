...
### 3. Присоединяйтесь к сообществу RyCode-Ext

- **Основной:** Присоединяйтесь к нашему [Discord](https://discord.gg/roocode) и напишите личное сообщение **Hannes Rudolph (`hrudolph`)**.
- **Альтернатива:** Опытные участники mogą напрямую взаимодействовать через [Проекты GitHub](https://github.com/orgs/RyCodeExtInc/projects/1).
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/RyCodeExtInc/RyCode-Ext/issues).
...
- Проверьте [Проект GitHub](https://github.com/orgs/RyCodeExtInc/projects/1) на наличие задач «Задача [не назначена]».
- Для документации посетите [Документацию RyCode-Ext](https://github.com/RyCodeExtInc/RyCode-Ext-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/RyCodeExtInc/RyCode-Ext/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией RyCode-Ext (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/RyCodeExtInc/RyCode-Ext/security/advisories/new).
...
```
git clone https://github.com/ВАШЕ_ИМЯ_ПОЛЬЗОВАТЕЛЯ/RyCode-Ext.git
```
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием RyCode-Ext.
