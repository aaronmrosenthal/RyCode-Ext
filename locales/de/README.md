...
<p align="center">
  <em>Schnelle Hilfe → <a href="https://discord.gg/roocode">Discord beitreten</a> • Lieber asynchron? → <a href="https://www.reddit.com/r/RyCodeExt/">r/RyCodeExt beitreten</a></em>
</p>
...
## Was kann RyCode-Ext für DICH tun?
...
RyCode-Ext passt sich an deine Arbeitsweise an, nicht umgekehrt:
...
Mehr erfahren: [Modi verwenden](https://docs.roocode.com/basic-usage/using-modes) • [Benutzerdefinierte Modi](https://docs.roocode.com/advanced-usage/custom-modes) • [Roomote Control](https://docs.roocode.com/rycode-ext-cloud/roomote-control)
...
- **[Dokumentation](https://docs.roocode.com):** Die offizielle Anleitung zur Installation, Konfiguration und Beherrschung von RyCode-Ext.
...
- **[Reddit-Community](https://www.reddit.com/r/RyCodeExt):** Teile deine Erfahrungen und sieh, was andere bauen.
- **[GitHub Issues](https://github.com/RyCodeExtInc/RyCode-Ext/issues):** Melde Fehler und verfolge die Entwicklung.
- **[Feature-Anfragen](https://github.com/RyCodeExtInc/RyCode-Ext/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hast du eine Idee? Teile sie mit den Entwicklern.
...
Es gibt mehrere Möglichkeiten, die RyCode-Ext-Erweiterung auszuführen:

### Entwicklungsmodus (F5)

Für die aktive Entwicklung verwende das integrierte Debugging von VSCode:

Drücke `F5` (oder gehe zu **Ausführen** → **Debuggen starten**) in VSCode. Dies öffnet ein neues VSCode-Fenster mit der laufenden RyCode-Ext-Erweiterung.
...
Danke an alle unsere Mitwirkenden, die geholfen haben, RyCode-Ext besser zu machen!
