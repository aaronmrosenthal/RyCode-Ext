...
<p align="center">
  <em>Ottieni aiuto velocemente → <a href="https://discord.gg/roocode">Unisciti a Discord</a> • Preferisci l'asincrono? → <a href="https://www.reddit.com/r/RyCodeExt/">Unisciti a r/RyCodeExt</a></em>
</p>
...
## Cosa può fare RyCode-Ext per TE?
...
RyCode-Ext si adatta al tuo modo di lavorare, non il contrario:
...
Scopri di più: [Usare le Modalità](https://docs.roocode.com/basic-usage/using-modes) • [Modalità personalizzate](https://docs.roocode.com/advanced-usage/custom-modes) • [Roomote Control](https://docs.roocode.com/rycode-ext-cloud/roomote-control)
...
- **[Documentazione](https://docs.roocode.com):** La guida ufficiale per installare, configurare e padroneggiare RyCode-Ext.
...
- **[Comunità Reddit](https://www.reddit.com/r/RyCodeExt):** Condividi le tue esperienze e guarda cosa stanno costruendo gli altri.
- **[Problemi GitHub](https://github.com/RyCodeExtInc/RyCode-Ext/issues):** Segnala bug e tieni traccia dello sviluppo.
- **[Richieste di funzionalità](https://github.com/RyCodeExtInc/RyCode-Ext/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hai un'idea? Condividila con gli sviluppatori.
...
Ci sono diversi modi per eseguire l'estensione RyCode-Ext:

### Modalità di sviluppo (F5)

Per lo sviluppo attivo, usa il debug integrato di VSCode:

Premi `F5` (o vai su **Esegui** → **Avvia debug**) in VSCode. Si aprirà una nuova finestra di VSCode con l'estensione RyCode-Ext in esecuzione.
...
Grazie a tutti i nostri contributori che hanno aiutato a migliorare RyCode-Ext!
