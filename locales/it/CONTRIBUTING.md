...
### 3. Unisciti alla community di RyCode-Ext

- **Principale:** Unisciti al nostro [Discord](https://discord.gg/roocode) e invia un DM a **Hannes Rudolph (`hrudolph`)**.
- **Alternativa:** I contributori esperti possono interagire direttamente tramite i [progetti GitHub](https://github.com/orgs/RyCodeExtInc/projects/1).
...
- **Controlla le issue esistenti**: cerca nelle [issue di GitHub](https://github.com/RyCodeExtInc/RyCode-Ext/issues).
...
- Controlla il [progetto GitHub](https://github.com/orgs/RyCodeExtInc/projects/1) per le issue "Issue [Non assegnata]".
- Per la documentazione, visita [RyCode-Ext Docs](https://github.com/RyCodeExtInc/RyCode-Ext-Docs).

### Segnalazione di bug

- Controlla prima le segnalazioni esistenti.
- Crea un nuovo bug utilizzando il [modello "Segnalazione di bug"](https://github.com/RyCodeExtInc/RyCode-Ext/issues/new/choose) con:
    - Passaggi di riproduzione chiari e numerati
    - Risultato previsto vs effettivo
    - Versione di RyCode-Ext (obbligatoria); provider/modello di intelligenza artificiale se pertinente
- **Problemi di sicurezza**: segnala in privato tramite [avvisi di sicurezza](https://github.com/RyCodeExtInc/RyCode-Ext/security/advisories/new).
...
```
git clone https://github.com/TUO_NOME_UTENTE/RyCode-Ext.git
```
...
Contribuendo, accetti che i tuoi contributi siano concessi in licenza con la licenza Apache 2.0, in coerenza con la licenza di RyCode-Ext.
