...
### 3. Junte-se à comunidade RyCode-Ext

- **Principal:** Junte-se ao nosso [Discord](https://discord.gg/roocode) e envie uma DM para **Hannes Rudolph (`hrudolph`)**.
- **Alternativa:** Contribuidores experientes могут se envolver diretamente através dos [Projetos do GitHub](https://github.com/orgs/RyCodeExtInc/projects/1).
...
- **Verifique as issues existentes**: Pesquise nas [Issues do GitHub](https://github.com/RyCodeExtInc/RyCode-Ext/issues).
...
- Verifique o [Projeto do GitHub](https://github.com/orgs/RyCodeExtInc/projects/1) para issues "Issue [Não atribuída]".
- Para documentação, visite [Documentação do RyCode-Ext](https://github.com/RyCodeExtInc/RyCode-Ext-Docs).

### Relatando bugs

- Verifique primeiro os relatórios existentes.
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/RyCodeExtInc/RyCode-Ext/issues/new/choose) com:
    - Passos de reprodução claros e numerados
    - Resultado esperado vs. real
    - Versão do RyCode-Ext (obrigatório); provedor/modelo de IA, se relevante
- **Problemas de segurança**: Relate em particular através de [avisos de segurança](https://github.com/RyCodeExtInc/RyCode-Ext/security/advisories/new).
...
```
git clone https://github.com/SEU_NOME_DE_USUARIO/RyCode-Ext.git
```
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do RyCode-Ext.
