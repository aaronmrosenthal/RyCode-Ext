...
RyCode-Ext 是一個由社群驅動的專案，我們非常重視每一份貢獻。為了簡化協作，我們採用 [「問題優先」的方法](#問題優先方法)，這意味著所有的 [拉取請求 (PR)](#提交拉取請求) 都必須先連結到一個 GitHub 問題。請仔細閱讀本指南。
...
- **替代方式：** 經驗豐富的貢獻者可以透過 [GitHub 專案](https://github.com/orgs/RyCodeExtInc/projects/1) 直接參與。
...
- **檢查現有問題**：在 [GitHub 問題](https://github.com/RyCodeExtInc/RyCode-Ext/issues) 中搜尋。
- **使用以下範本建立問題**：
...
- 查看 [GitHub 專案](https://github.com/orgs/RyCodeExtInc/projects/1) 中的「問題 [未分配]」問題。
- 如需文件，請造訪 [RyCode-Ext 文件](https://github.com/RyCodeExtInc/RyCode-Ext-Docs)。

### 報告錯誤

- 首先檢查現有的報告。
- 使用 [「錯誤報告」範本](https://github.com/RyCodeExtInc/RyCode-Ext/issues/new/choose) 建立一個新錯誤，並提供：
    - 清晰、編號的重現步驟
    - 預期與實際結果
    - RyCode-Ext 版本（必需）；如果相關，還需提供 API 提供商/模型
- **安全問題**：透過 [安全公告](https://github.com/RyCodeExtInc/RyCode-Ext/security/advisories/new) 私下報告。
...
```
git clone https://github.com/您的使用者名稱/RyCode-Ext.git
```
...
透過貢獻，您同意您的貢獻將根據 Apache 2.0 授權進行授權，這與 RyCode-Ext 的授權一致。
