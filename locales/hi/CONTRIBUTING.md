...
### 3. RyCode-Ext समुदाय में शामिल हों

- **प्राथमिक:** हमारे [डिस्कॉर्ड](https://discord.gg/roocode) में शामिल हों और **Hannes Rudolph (`hrudolph`)** को डीएम करें।
- **वैकल्पिक:** अनुभवी योगदानकर्ता [गिटहब प्रोजेक्ट्स](https://github.com/orgs/RyCodeExtInc/projects/1) के माध्यम से सीधे जुड़ सकते हैं।
...
- **मौजूदा समस्याओं की जाँच करें**: [गिटहब समस्याएँ](https://github.com/RyCodeExtInc/RyCode-Ext/issues) में खोजें।
...
- "समस्या [असाइन नहीं की गई]" समस्याओं के लिए [गिटहब प्रोजेक्ट](https://github.com/orgs/RyCodeExtInc/projects/1) की जाँच करें।
- दस्तावेज़ों के लिए, [RyCode-Ext दस्तावेज़](https://github.com/RyCodeExtInc/RyCode-Ext-Docs) पर जाएँ।

### बग की रिपोर्ट करना

- पहले मौजूदा रिपोर्ट की जाँच करें।
- ["बग रिपोर्ट" टेम्पलेट](https://github.com/RyCodeExtInc/RyCode-Ext/issues/new/choose) का उपयोग करके एक नया बग बनाएँ:
    - स्पष्ट, क्रमांकित पुनरुत्पादन चरण
    - अपेक्षित बनाम वास्तविक परिणाम
    - RyCode-Ext संस्करण (आवश्यक); यदि प्रासंगिक हो तो एपीआई प्रदाता/मॉडल
- **सुरक्षा समस्याएँ**: [सुरक्षा सलाहकारों](https://github.com/RyCodeExtInc/RyCode-Ext/security/advisories/new) के माध्यम से निजी तौर पर रिपोर्ट करें।
...
```
git clone https://github.com/आपका_उपयोगकर्ता_नाम/RyCode-Ext.git
```
...
योगदान करके, आप सहमत हैं कि आपके योगदान अपाचे 2.0 लाइसेंस के तहत लाइसेंस प्राप्त होंगे, जो RyCode-Ext के लाइसेंस के अनुरूप है।
