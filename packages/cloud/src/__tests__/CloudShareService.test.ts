...
import type { SettingsService, AuthService } from "@rycode-ext/types"
...
vi.mock("../Config", () => ({
	getRyCodeExtApiUrl: () => "https://app.roocode.com",
}))

vi.mock("../utils", () => ({
	getUserAgent: () => "RyCode-Ext 1.0.0",
}))
