...
This package provides IPC functionality for RyCode-Ext, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: RyCodeExt settings object
...
- Unix/Linux/macOS: `/tmp/rycode-ext-{id}.sock`
- Windows: `\\.\pipe\rycode-ext-{id}`
