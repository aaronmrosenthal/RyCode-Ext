...
import type { RyCodeExtEvents } from "./events.js"
...
export type RyCodeExtAPIEvents = RyCodeExtEvents

export interface RyCodeExtAPI extends EventEmitter<RyCodeExtAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): RyCodeExtSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: RyCodeExtSettings): Promise<void>
	/**
...
export interface RyCodeExtIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
