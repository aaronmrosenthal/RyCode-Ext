...
const faqs: FAQItem[] = [
	{
		question: "What exactly is RyCode-Ext?",
		answer: (
			<>
				RyCode-Ext is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does RyCode-Ext differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				RyCode-Ext is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: RyCode-Ext is{" "}
	...
	{
		question: "Is RyCode-Ext really free?",
		answer: (
			<>
				Yes! RyCode-Ext is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because RyCode-Ext is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .rycodeextignore to exclude sensitive files, and you can also run RyCode-Ext with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does RyCode-Ext support?",
		answer: (
			<>
				RyCode-Ext is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows RyCode-Ext&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does RyCode-Ext support my programming language?",
		answer: (
			<>
				Likely yes! RyCode-Ext supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. RyCode-Ext uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about RyCode-Ext for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. RyCode-Ext was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because RyCode-Ext is fully open-source, it&apos;s auditable—you can review exactly how it
	...
	{
		question: "Can RyCode-Ext run commands and tests automatically?",
		answer: (
			<>
				Yes! One of RyCode-Ext&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				RyCode-Ext shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to RyCode-Ext?",
		answer: (
			<>
				Yes, please do! RyCode-Ext is open-source on{" "}
				<a
					href="https://github.com/RyCodeExtInc/RyCode-Ext"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
				...
				and{" "}
				<a
					href="https://reddit.com/r/RyCodeExt"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Reddit
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://www.youtube.com/@RyCodeExtYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about RyCode-Ext and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
