...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping RyCode-Ext's enterprise solution."
			: "Fill out the form below to see RyCode-Ext's enterprise capabilities in action."
