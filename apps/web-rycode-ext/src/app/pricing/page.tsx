...
const TITLE = "Pricing - RyCode-Ext Cloud"
const DESCRIPTION =
	"Simple, transparent pricing for RyCode-Ext Cloud. The VS Code extension is free forever. Choose the cloud plan that fits your needs."
const PATH = "/pricing"
			...
			<section className="relative overflow-hidden pt-16 pb-12">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<h1 className="text-5xl font-bold tracking-tight">RyCode-Ext Cloud Pricing</h1>
			...
			<div className="mx-auto max-w-6xl">
				<div className="rounded-xl p-4 mb-8 text-center bg-gradient-to-r from-blue-500/10 via-cyan-500/10 to-purple-500/10 border border-blue-500/20 dark:border-white/20">
					<p className="text-center">
						<strong className="font-semibold">The RyCode-Ext extension is free! </strong>
						RyCode-Ext Cloud is an optional service which takes it to the next level.
					</p>
				</div>
			</div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-2">
						<div className="rounded-lg border border-border bg-card p-6">
							<h3 className="font-semibold">Wait, is RyCode-Ext free or not?</h3>
							<p className="mt-2 text-sm text-muted-foreground">
								Yes! The RyCode-Ext VS Code extension is open source and free forever. The extension acts
			...
			<section className="py-20">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-4xl rounded-3xl border border-border/50 bg-gradient-to-br from-blue-500/5 via-cyan-500/5 to-purple-500/5 p-8 text-center shadow-2xl backdrop-blur-xl dark:border-white/20 dark:bg-gradient-to-br dark:from-gray-800 dark:via-gray-900 dark:to-black sm:p-12">
						<h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">Try RyCode-Ext Cloud now</h2>
