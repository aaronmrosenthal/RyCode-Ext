...
const DESCRIPTION =
	"Privacy policy for RyCode-Ext Cloud and marketing website. Learn how we handle your data and protect your privacy."
const PATH = "/privacy"
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						RyCode-Ext Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how RyCode-Ext, Inc. (&quot;RyCode-Ext,&quot; &quot;we,&quot;
					...
					<ul className="lead">
						...
						<li>
							create an account for, sign in to, or otherwise use <strong>RyCode-Ext Cloud</strong> at{" "}
							<strong>app.roocode.com</strong> or through the RyCode-Ext extension while authenticated to
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the RyCode-Ext extension <strong>without</strong> connecting to a Cloud account,
							your data is governed by the standalone{" "}
							<a
								href="https://github.com/RyCodeExtInc/RyCode-Ext/blob/main/PRIVACY.md"
								target="_blank"
								rel="noopener noreferrer"
								className="text-primary hover:underline">
								RyCode-Ext Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit RyCode-Ext servers unless you explicitly choose RyCode-Ext
								as a model provider (proxy mode).
							</strong>{" "}
							When RyCode-Ext Cloud is your model provider, your code briefly transits RyCode-Ext servers only
							...
							TLS—to the model you select. RyCode-Ext never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in RyCode-Ext Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate RyCode-Ext Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure RyCode-Ext Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or RyCode-Ext (proxy
										mode; transit‑only) when you select RyCode-Ext as the provider
									</td>
									<td className="border border-border px-4 py-2">
										RyCode-Ext servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										RyCode-Ext Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										RyCode-Ext servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on RyCode-Ext servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside RyCode-Ext Cloud.
						</li>
						<li>
